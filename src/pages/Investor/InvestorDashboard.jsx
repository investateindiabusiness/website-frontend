  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="flex-grow mt-16 pb-12">
        ...
        {/* --- HERO SECTION --- */}
        <div className="bg-gradient-to-r from-[#0b264f] to-[#1a4b8c] text-white pt-10 pb-16 px-4 md:px-8 rounded-b-[2.5rem] shadow-xl relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-bold mb-1">Welcome, Rahul</h1>
              ...
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl flex items-center gap-4 border border-white/10">
                 <div className="text-center px-2">
                    <p className="text-2xl font-bold text-white">{properties.filter(p => p.isShortlisted).length}</p>
                    <p className="text-xs text-blue-200 uppercase tracking-wider">Saved</p>
                 </div>
                 <div className="h-8 w-px bg-white/20"></div>
                 <div className="text-center px-2">
                    <p className="text-2xl font-bold text-white">{MY_INQUIRIES.length}</p>
                    <p className="text-xs text-blue-200 uppercase tracking-wider">Visited</p>
                 </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 -mt-8 relative z-20">
          ...
          {/* --- SEARCH BAR (Floating) --- */}
          <div className="bg-white rounded-2xl shadow-lg p-2 flex items-center gap-2 max-w-3xl mx-auto mb-10 border border-gray-100">
            <div className="pl-4">
            ...
            <input 
              ...
              className="flex-grow py-3 px-2 outline-none text-gray-700 placeholder-gray-400 font-medium bg-transparent"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <Button className="rounded-xl h-12 px-6 bg-[#0b264f] hover:bg-blue-900 text-white shadow-md transition-all">
              Search
            </Button>
          </div>
          ...
          <div className="mt-12 mb-4 flex items-center justify-between px-1">
