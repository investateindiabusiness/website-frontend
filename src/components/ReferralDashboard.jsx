...
export default function ReferralDashboard({ role = 'Investor' }) {
  ...
  const referralLink = referralCode ? `https://nrifederation.business/register?ref=${referralCode}` : '';
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-blue-100/80 text-sm md:text-base max-w-lg">
              Invite your network to NRI Federation Business and earn exclusive rewards for every successful onboarding.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl w-full md:w-auto">
            ...
            <div className="flex items-center gap-2 bg-black/20 p-2 rounded-xl border border-white/10">
              ...
              <Button
                ...
                className={`rounded-lg transition-all shrink-0 ${copied ? 'bg-green-500 hover:bg-green-600' : 'bg-orange-500 hover:bg-orange-600'
