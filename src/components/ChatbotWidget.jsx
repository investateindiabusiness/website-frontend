...
export default function ChatbotWidget() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[80] font-sans">
      {open && (
        <section
          className="mb-4 flex max-w-[410px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/20"
          style={{ maxHeight: "75vh", width: "calc(100vw - 2.5rem)" }}
        >
          <header className="flex shrink-0 items-center justify-between bg-[#0b264f] px-4 py-3 text-white">
