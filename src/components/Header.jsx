          ...
          <div className="flex items-center shrink-0 relative" ref={logoMenuRef}>
            {user?.role === 'admin' ? (
              <>
                ...
                >
                  <img src="/images/NRI%20Logo.png" alt="LOGO" className="hidden md:block h-12 w-auto object-contain" />
                  <img src="/images/NRI%20Logo.png" alt="LOGO" className="block md:hidden h-10 w-auto object-contain" />
