...
export default function TicketDetail() {
  ...
  if (!user || loading) {
    return (
      <div className={`flex-grow flex items-center justify-center ${!isDashboard ? 'h-[calc(100vh-8rem)] mt-[4rem] md:mt-[5rem]' : 'h-[60vh]'}`}>
  ...
  return (
    <main className={`flex-grow pb-12 px-4 md:px-8 max-w-5xl mx-auto w-full flex flex-col h-[calc(100vh-8rem)] ${!isDashboard ? 'mt-[4rem] md:mt-[5rem]' : 'pt-4'}`}>
