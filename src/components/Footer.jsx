      ...
      <div className="container relative z-10 mx-auto px-6 py-16 md:py-20 max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.6fr_0.6fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              NRI Federation Business is a trusted investment ecosystem connecting global investors, builders, businesses, and professional partners through transparency, innovation, and verified opportunities.
            </p>
        ...
        <div className="mt-16 border-t border-white/[0.06] pt-8">
          <p className="text-center text-xs text-gray-400 tracking-wider">
            © {new Date().getFullYear()} NRI FEDERATION BUSINESS. All rights reserved.
          </p>

          <p className="mx-auto mt-4 max-w-5xl text-center text-[11px] leading-relaxed text-gray-500">
            Disclaimer: NRI Federation Business acts as a facilitation platform
