      ...
      <Box sx={{
        ...
        {!collapsed && (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <img src="/images/NRI%20Logo.png" alt="Logo" style={{ height: 48, objectFit: 'contain' }} />
          </Box>
        )}
        <IconButton
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Link href={getDashboardPath(user?.role)} onClick={() => setMobileOpen(false)}>
          <img src="/images/NRI%20Logo.png" alt="Logo" style={{ height: 40, objectFit: 'contain' }} />
        </Link>
        <IconButton
          onClick={() => setMobileOpen(false)}
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Box sx={{
              ...
              <Link href={getDashboardPath(user?.role)} style={{ display: 'flex', alignItems: 'center' }}>
                <img src="/images/NRI%20Logo.png" alt="Logo" style={{ height: 36, objectFit: 'contain' }} />
              </Link>
            </Box>
            ...
            <Box sx={{
              ...
              <Link href="/" style={{ display: 'flex', alignItems: 'center' }}>
                <img src="/images/NRI%20Logo.png" alt="Logo" style={{ height: 38, objectFit: 'contain' }} />
              </Link>
            </Box>
          </Box>
