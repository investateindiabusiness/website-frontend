...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/images/NRI%20Logo.png', sizes: '32x32', type: 'image/png' },
      { url: '/images/NRI%20Logo.png', sizes: '64x64', type: 'image/png' },
      { url: '/images/NRI%20Logo.png', sizes: '128x128', type: 'image/png' },
      { url: '/images/NRI%20Logo.png', sizes: '256x256', type: 'image/png' },
      { url: '/images/NRI%20Logo.png', sizes: '512x512', type: 'image/png' },
      { url: '/images/NRI%20Logo.png', sizes: '1024x1024', type: 'image/png' },
    ],
    apple: '/images/NRI%20Logo.png',
    shortcut: '/images/NRI%20Logo.png',
  },
  openGraph: {
    title: 'Global NRIs Investment in India Real Estate | Investate',
    description: 'Investate India is the trusted gateway for Global NRIs investment in India real estate. Explore premium vetted properties with absolute transparency.',
...
const schemaJson = {
  ...
  "url": "https://dev.investateindia.brvteck.com",
  "logo": "https://dev.investateindia.brvteck.com/images/NRI%20Logo.png",
  "image": "https://dev.investateindia.brvteck.com/images/NRI%20Logo.png",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <link rel="icon" type="image/png" href="/images/NRI%20Logo.png?v=2" />
