...
const heroSlides = [
  {
    ...
    subtitle:
      "Partner with NRI Federation Business to offer legal, financial, property, and advisory services to NRIs, investors, and developers through a trusted platform.",
  },
  {
...
const serviceProviderSteps = [
  ...
  },
  {
    id: "3",
    title: "Get Listed",
    text: "Showcase your services inside NRI Federation Business and become visible to NRIs, investors, and real estate partners.",
  },
  {
    id: "4",
    title: "Connect",
...
const faqsList = [
  {
    question: "Who can become an NRI Federation Business service partner?",
    answer:
  ...
  {
    question: "How does NRI Federation Business help service providers?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Interested clients can reach verified service partners through NRI Federation Business’s structured connection process.",
  },
  {
    question: "Can companies register as service providers?",
    answer:
      "Yes. Both individual professionals and companies offering relevant services can become NRI Federation Business partners.",
  },
];
...
export default function ServiceProviderHome() {
  ...
  return (
    <div className="theme-builder w-full bg-[var(--color-light-bg)] overflow-x-hidden">
      ...
      "
            >
              Partner with NRI Federation Business to support global NRIs, investors,
        ...
        <div className="container">
          <div className="faq-header-full text-center mb-16">
            ...
            <p className="faq-premium-subtitle mx-auto">
              ...
              services on NRI Federation Business.
            </p>
          </div>
      ...
      >
        <div className="container max-w-3xl mx-auto px-4">
          ...
          <p className="text-slate-400 mb-8 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
            Partner with NRI Federation Business and connect your professional expertise
