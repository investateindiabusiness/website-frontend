          ...
          {loading ? (
            ...
            const renderStatusBadge = () => {
              switch (builder.onboardingStatus) {
                ...
                case 'form1_approved': return <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 border-none"><Clock className="w-3 h-3 mr-1" /> Form 1 Approved</Badge>;
                default: return <Badge className="bg-gray-100 text-gray-700 hover:bg-gray-100 border-none">{builder.onboardingStatus || 'Unknown'}</Badge>;
              }
            };
