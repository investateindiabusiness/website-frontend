        ...
        <div className="font-sans">
            <div className="flex-grow container mx-auto px-4 py-6 sm:py-8 max-w-7xl">
                <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-6">
                    <div><h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">Lead Management</h1><p className="text-gray-600 text-sm">Track and manage investor inquiries.</p></div>
