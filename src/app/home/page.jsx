...
const heroSlides = [
  {
    ...
    subtitle:
      "Connecting Investors, Opportunities and Professional Services through a technology-enabled platform.",
  },
  {
    ...
    subtitle:
      "Designed primarily for Non-Resident Indians (NRIs), simplifying the investment journey by bringing together opportunities, professional services, and trusted partners.",
  },
];
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-300">
                {[
                  ...
                  <div key={i}>
                    <div className="text-2xl md:text-3xl font-bold text-[#1a1a1a] leading-none">
                      {item.stat}
                    </div>
                    <p className="text-xs font-semibold text-slate-500 mt-1.5 leading-tight">
                      {item.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="lg:col-span-7 flex flex-col gap-10">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm md:text-base leading-relaxed">
                  NRI Federation Business is a technology-enabled investment platform
                  designed to facilitate participation in Indian investment
                  opportunities through a curated ecosystem of investors,
                  opportunity providers and professional service partners.
                </p>
              </div>
      ...
      <section id="challenges" className="infra-section py-20 bg-[#f8f8f8]">
        <div className="infra-section-header text-center mb-12">
          <h2 className="infra-title text-3xl md:text-4xl font-bold text-[#1a1a1a]">
            Business Model{" "}
            <span className="infra-title-accent text-[#D48035]">& Focus</span>
          </h2>
          <p className="infra-subtitle max-w-2xl mx-auto mt-4 text-slate-600">
            Our collaborative model integrates developers, investors, and legal
            or financial service providers to streamline secure, cross-border
            capital deployment and compliance.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div>
                ...
                >
                  Connecting <br />
                  <span style={{ color: "#D48035" }}>Global Capital</span>
                </h2>
                <p className="responsive-paragraph text-slate-600 mb-8 max-w-lg">
                  We connect global investors, NRIs, and wealth managers
                  directly to high-yield Indian market opportunities.
                </p>
      ...
      >
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
              Key hurdles Non-Resident Indians (NRIs) face when investing and
              managing property assets in India from abroad.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto text-left mt-12">
            {[
              ...
              <div
                key={i}
                className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-8 rounded-3xl shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
              >
