...
const builderChallenges = [
  ...
  },
  {
    ...
    desc: "Focus on creating quality developments while NRI Federation Business connects you with global opportunities.",
...
const faqsList = [
  {
    ...
    answer:
      "Real estate developers with residential, commercial, villa, township, or upcoming projects can apply to showcase opportunities through NRI Federation Business.",
  },
  {
    question: "How does NRI Federation Business help builders?",
    answer:
  ...
  {
    question: "Can NRI Federation Business support capital requirements?",
    answer:
          ...
          <div className="trust-split-wrapper">
            <div className="trust-info-side">
              ...
              <p className="trust-main-desc">
                NRI Federation Business helps credible developers increase global
        ...
        <div className="container">
          <div className="faq-header-full text-center mb-16">
            ...
            <p className="faq-premium-subtitle mx-auto">
              Learn how NRI Federation Business helps developers expand their reach,
